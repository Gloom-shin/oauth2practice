package oauth2.practice.api.controller.auth;
...
import oauth2.practice.api.entity.auth.AuthReqModel;
import oauth2.practice.api.entity.user.UserRefreshToken;
import oauth2.practice.api.repository.UserRefreshTokenRepository;
import oauth2.practice.common.ApiResponse;
...
public class AuthController {
    ...
    public ApiResponse refreshToken(HttpServletRequest request, HttpServletResponse response) {
        ...
        // refresh token
        String refreshToken = CookieUtil.getCookies(request, REFRESH_TOKEN)
                .map(Cookie::getValue)
                .orElse((null));
